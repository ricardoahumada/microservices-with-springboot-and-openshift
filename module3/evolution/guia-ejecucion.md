...
```bash
curl http://localhost:8084/api/validaciones/status -v
curl http://localhost:8082/api/beneficios/status -v
curl http://localhost:8083/api/notificaciones/status -v
curl http://localhost:8081/api/afiliados/status -v
```
...
```bash
curl -X POST "http://localhost:8081/api/test/resiliencia/validacion?dni=12345678A&empresaId=EMP001&simulateError=TIMEOUT" | json_pp
```
...
```bash
curl -X POST "http://localhost:8081/api/test/resiliencia/validacion?dni=12345678A&empresaId=EMP001&simulateError=ERROR_500" | json_pp
```
...
```bash
curl -X POST "http://localhost:8081/api/test/resiliencia/validacion?dni=12345678A&empresaId=EMP001&simulateError=ERROR_503" | json_pp
```
...
```bash
curl -X POST "http://localhost:8081/api/test/resiliencia/validacion?dni=12345678A&empresaId=EMP001&simulateError=SLOW" | json_pp
```
...
```bash
curl http://localhost:8081/api/test/resiliencia/circuit-breakers | json_pp
```
...
```bash
curl -X POST http://localhost:8081/api/test/resiliencia/circuit-breakers/validacionService/force-open | json_pp
```
...
```bash
curl -X POST http://localhost:8081/api/test/resiliencia/circuit-breakers/validacionService/reset | json_pp
```
