...
Plataforma de microservicios para gestion de mutualidad.

## Servicios

| Servicio | Puerto | Descripcion |
|----------|--------|-------------|
| afiliado-service | 8081 | Gestion de afiliados |
| beneficio-service | 8082 | Gestion de beneficios y solicitudes |
| notificacion-service | 8083 | Gestion de notificaciones |
